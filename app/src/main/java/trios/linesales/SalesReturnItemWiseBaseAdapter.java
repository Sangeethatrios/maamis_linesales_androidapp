...
class SalesReturnItemWiseBaseAdapter extends BaseAdapter {
    ...
    public SalesReturnItemWiseBaseAdapter( Context context,ArrayList<SalesItemWiseReportDetails> myList) {
        this.myList = myList;
...
//            mDbErrHelper.close();
    ...
    public void calculateTotalAmount() {
        ...
        try {
            ...
            SalesReturnItemWiseReportActivity.itemlisttotalamount.setText("Total  \u20B9 "+df.format(addamt));
