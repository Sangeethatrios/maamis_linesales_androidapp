...
//      public  static  String urlString = "http://"+LoginActivity.ipaddress+"/";
  ...
  public  static  String urlString = LoginActivity.ipaddress+"/";
    //local ip
//public  static  String urlString = "http://172.16.1.121:80/";
   // public  static  String urlString = "http://"+LoginActivity.ipaddress+"/";
...
//            Log.i("LoginException",myResponse.getString("success"));
    ...
    public JSONObject ExpenseDetails(String paraexpensedetails,Context ctx) throws Exception {
        ...
        String data = "&" + URLEncoder.encode("paraexpensedetails", "UTF-8") + "="
                + URLEncoder.encode(paraexpensedetails, "UTF-8");
        data +="&" +  URLEncoder.encode("paravancode", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString("getvancode"), "UTF-8");
        data +="&" +  URLEncoder.encode("paraimeino", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString("deviceid"), "UTF-8");
    ...
    public JSONObject ReceiptDetails(String parareceiptdetails,Context ctx) throws Exception {
        ...
        String data = "&" + URLEncoder.encode("parareceiptdetails", "UTF-8") + "="
                + URLEncoder.encode(parareceiptdetails, "UTF-8");
        data +="&" +  URLEncoder.encode("paravancode", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString("getvancode"), "UTF-8");
        data +="&" +  URLEncoder.encode("paraimeino", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString("deviceid"), "UTF-8");
    ...
    //transaction history
    public JSONObject GetRecentTrans(String customercode,String paraphpfile) throws Exception {
        String url;
        ...
        String data = "&" +URLEncoder.encode("paracustomercode", "UTF-8") + "="
                + URLEncoder.encode(customercode, "UTF-8");
        // Send data
        try {
            //Read JSON response and print
            myResponse = new JSONObject(GetJSONResponse(url, data));
    ...
    public JSONObject insertNotPurchasedDetails(String parasalearray,Context ctx) throws Exception {
        String url;
        preferenceMangr = new PreferenceMangr(ctx);

        url = urlString + "insertnotpurchaseddetails.php";

        JSONObject myResponse = null;

        String data = "&" + "notpurchasedarray" + "="
                + parasalearray;
        data +="&" +  URLEncoder.encode("paravancode", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString(Constants.KEY_GETVANCODE), "UTF-8");
        data +="&" +  URLEncoder.encode("paraimeino", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString(Constants.KEY_DEVICEID), "UTF-8");
        // Send data
        try {
            //Read JSON response and print
            myResponse = new JSONObject(GetJSONResponse(url, data));
    ...
    public JSONObject GetNotPurchasedDetails(String paraimeino,String paraphpfile, Context ctx) throws Exception {
        String url;
        preferenceMangr = new PreferenceMangr(ctx);
        ...
        String data = "&" +URLEncoder.encode("paraimeino", "UTF-8") + "="
                + URLEncoder.encode(paraimeino, "UTF-8");
        data +="&" +  URLEncoder.encode("paraschedulecode", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString(Constants.KEY_GET_SCHEDULE_SCHEDULECODE), "UTF-8");
        data +="&" +  URLEncoder.encode("paravancode", "UTF-8")
                + "=" + URLEncoder.encode(preferenceMangr.pref_getString(Constants.KEY_GETVANCODE), "UTF-8");
        // Send data
        try {
    ...
    public JSONObject sendSMS(String paraphpfile,Context ctx,String paramobileno,String parabillno,String parabillamount, String paymentType, String upiTransNo) throws Exception {
        String url;
        preferenceMangr = new PreferenceMangr(ctx);
        url = urlString + paraphpfile;
        ...
        String data = "&" +URLEncoder.encode("paramobileno", "UTF-8") + "="
                + URLEncoder.encode(paramobileno, "UTF-8");
        data += "&" +URLEncoder.encode("parabillno", "UTF-8") + "="
                + URLEncoder.encode(parabillno, "UTF-8");
        data += "&" +URLEncoder.encode("parabillamount", "UTF-8") + "="
                + URLEncoder.encode(parabillamount, "UTF-8");
        data += "&" +URLEncoder.encode("parapaymenttype", "UTF-8") + "="
                + URLEncoder.encode(paymentType, "UTF-8");
        data += "&" +URLEncoder.encode("paraupitransno", "UTF-8") + "="
                + URLEncoder.encode(upiTransNo, "UTF-8");
        // Send data
        try {
            //Read JSON response and print
            myResponse = new JSONObject(GetJSONResponse(url, data));
//            Log.i("LoginException",myResponse.getString("success"));
    ...
    public JSONObject checkCustomerMobileNumber(String paramobileno,String paraphpfile,Context ctx) throws Exception {
        String url;
        preferenceMangr = new PreferenceMangr(ctx);
        url = urlString + paraphpfile;
...
//            Log.i("LoginException",myResponse.getString("success"));
            ...
            Log.i("checkCustomerMobileNumber", ex.toString());
        }
