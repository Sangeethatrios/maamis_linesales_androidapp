...
public class ShareDataBaseBackup {
    ...
    public static void ShareDBBackup(Activity activity, Context context){
        ...
        try{
            ...
            Utilities.InsertError(context, e.getLocalizedMessage(), "ShareDBBackup");
        }finally {
...
//----------------------------------------------------------------------------------------------
    ...
    public static int BUFFER_SIZE = 6 * 1024;
    public static void zip(String[] files, String zipFile, Context context) throws IOException {
        ...
        try {
            ...
            Utilities.InsertError(context, e.getLocalizedMessage(), "Zip file generation");
        } finally {
            out.close();
        }
    }
...
//-----------------------------------------------------------------------------------------------
    ...
    public static  void ShareToAll_Above_Android7(Activity activity, Context context, String filePath){
        try {
            ...
            Utilities.InsertError(context, e.getLocalizedMessage(), "ShareToAll_Above_Android7");
        }
    }
    ...
    public static void ShareToAll_Below_Android7(Activity activity, String filePath){
        try {
            ...
            Utilities.InsertError(activity.getApplicationContext(), e.getLocalizedMessage(), "ShareToAll_Above_Android7");
        }
    }
}
