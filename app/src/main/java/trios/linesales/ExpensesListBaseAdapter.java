...
public class ExpensesListBaseAdapter extends BaseAdapter {
    LayoutInflater inflater;
    Context context;
    ArrayList<ExpensesDetails> myList;
    DecimalFormat dft = new DecimalFormat("0.00");

    public ExpensesListBaseAdapter( Context context,ArrayList<ExpensesDetails> myList) {
        this.myList = myList;
    ...
    public void calculateTotalAmount() {
        ...
        try {
            ...
            ExpensesActivity.expensestotalamt.setText("\u20B9 "+df.format(addamt));
            Double gettripadavance = Double.parseDouble(ExpensesActivity.expensestripadvance.getText().toString());
            Double getbalamt = gettripadavance-addamt;
            ExpensesActivity.expensesremainingamt.setText("\u20B9 "+df.format(getbalamt));
